<?php
require_once '../Ecommerce-website/models/Product.php'; 
require_once '../Ecommerce-website/models/Coupon.php'; 
require_once '../Ecommerce-website/models/Order.php'; 
require_once '../Ecommerce-website/models/OrderItem.php'; 
