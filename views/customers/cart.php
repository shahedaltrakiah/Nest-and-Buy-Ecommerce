                                ...
                                if (isset($cart) && !empty($cart)):
                                    foreach ($cart as $product_id => $product):
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-price">JD
                                                <span class="unit-price" data-product-id="<?= $product_id; ?>"
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity-container">
                                                    ...
                                                    <span class="quantity-display"
                                                          id="quantityDisplay_<?= $product_id; ?>"
                                                          data-product-id="<?= $product_id; ?>">
                                            ...
                                            <td class="product-total" id="productTotal_<?= $product_id; ?>">
                                                JD<?= number_format($total, 2); ?></td>
                                            <td class="product-remove">
                                                <button onclick="removeProduct('<?= $product_id; ?>')"
