...
<div class="untree_co-section before-footer-section bg-light py-5">
    ...
    <button onclick="removeProduct('<?php echo $product_id; ?>')" style="border: none; background: none; padding: 0; cursor: pointer; font-size: 30px;">
        &times;
    </button>
</td>
                                    </tr>
            ...
            <div class="col-md-4">
                <div class="border p-4 rounded bg-white mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 text-end">
                            <strong class="text-black">
                                $<?php echo number_format($subtotal - ($_SESSION['discount'] ?? 0), 2); ?>
                            </strong>
                        </div>
                    </div>
    ...
    <?php else: ?>
        ...
        <form method="post" action="/customers/cart/apply-coupon" class="d-flex mb-3 justify-content-center">
            <input type="text" class="form-control me-2" id="coupon" name="coupon_code" placeholder="Coupon Code" required style="max-width: 250px;">
